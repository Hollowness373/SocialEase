...
const FeedPost = ({post}) => {
    ...
    return (
    	<View style={styles.post}>
    		{/* HEADER */}
            <TouchableOpacity style={styles.header} onPress={onPressProfile}>
                {user?.image ? (
                    <S3Image imgKey={user?.image} style={styles.profileImage} />
                    ) : (
                ...
                <View>
                    ...
                    <Text style={styles.subtitle}>{moment(post?.createdAt).format('LLL')}</Text>
                </View>
            ...
            <View style={styles.statsRow}>
              ...
              <Text style={styles.likedBy}>{post?.numberOfLikes}</Text> 
